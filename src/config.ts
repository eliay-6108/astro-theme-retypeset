...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    // site subtitle
    subtitle: 'Every line is about you',
    // site description
  ...
  footer: {
    ...
    links: [
      {
        name: 'BiliBili',
        url: 'https://space.bilibili.com/1069258889', // or /rss.xml
      },
      {
        name: 'GitHub',
        url: 'https://github.com/eliay-6108/astro-theme-retypeset',
      },
      {
        name: 'Email',
        url: 'linkong0604@163.com',
      },
      // {
      //   name: 'X',
